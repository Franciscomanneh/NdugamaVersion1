...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // PERFORMANCE: All context functions are wrapped in useCallback to ensure stable references.
  // This prevents unnecessary re-renders in consumer components and avoids triggering
  // effects in child components that depend on these functions.
  ...
  // PERFORMANCE: The context value object is memoized to prevent re-rendering ALL consumer
  // components when AppProvider re-renders for internal state changes or parent updates.
  // Consuming components will now only re-render if the specific data they use from the
