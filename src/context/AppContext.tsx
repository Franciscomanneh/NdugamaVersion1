...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Performance Optimization: Memoize the context value and functions
  // to prevent unnecessary re-renders of all consumer components.
  // By ensuring stable references for functions and the value object,
  // components using `useAppContext` only re-render when the actual state
