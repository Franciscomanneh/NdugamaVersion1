...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // PERFORMANCE: memoizing context functions to ensure stable references and prevent re-renders in consuming components
  ...
  // PERFORMANCE: memoizing context value to ensure that subscribers only re-render when actual state changes
  const contextValue = useMemo(() => ({
    ...
    clearCart, location, setLocation, favorites, toggleFavorite, products, bundles,
    sellers, orders, addOrder, updateOrderStatus, markOrderCompleted,
