...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt Optimization: Memoized context functions with functional state updates
  // to ensure stable references and prevent global re-render cascades.
  ...
  // ⚡ Bolt Optimization: Memoize the provider value to prevent
  // every consumer from re-rendering when AppProvider parent re-renders.
