...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Memoized actions to prevent stable functions from triggering re-renders
  ...
  // Memoized context value to prevent global re-render cascades
  // This ensures that consuming components only re-render when actual data changes
