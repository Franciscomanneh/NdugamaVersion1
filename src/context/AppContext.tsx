...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // BOLT OPTIMIZATION: Memoized context functions to prevent unnecessary re-renders of consumer components.
  // We use functional state updates to keep dependency arrays minimal and avoid stale closures.
  ...
  // BOLT OPTIMIZATION: Memoized context value to ensure the provider object remains stable between renders.
  // This prevents all consumer components from re-rendering unless a specific state they depend on changes.
