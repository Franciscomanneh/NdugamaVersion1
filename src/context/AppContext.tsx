...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt: Memoize logout function to prevent unnecessary re-renders
  const logout = useCallback(async () => {
    await firebaseService.logoutUser();
  }, []);

  // ⚡ Bolt: Memoize cart operations to prevent unnecessary re-renders
  ...
  // ⚡ Bolt: Memoize order operations to prevent unnecessary re-renders
  ...
  // ⚡ Bolt: Memoize favorites operation
  const toggleFavorite = useCallback((id: string) => {
    setFavorites(prev => prev.includes(id) ? prev.filter(f => f !== id) : [...prev, id]);
  }, []);

  // ⚡ Bolt: Memoize profile operations
  ...
  // ⚡ Bolt: Memoize the entire context value to prevent global re-render cascades
  // This ensures that components only re-render if the specific parts of the context they use change
