...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ⚡ OPTIMIZATION: Wrap all context functions in useCallback with stable dependencies
  // This prevents consumer components from re-rendering unless the actual data they use changes.
  ...
  // ⚡ OPTIMIZATION: Memoize the entire context value to prevent global re-render cascades.
  // Using functional state updates (setCart(prev => ...)) allows us to keep useCallback
  // dependency arrays empty, further stabilizing the context value.
