...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Memoized functions to maintain referential identity and prevent unnecessary re-renders in consumer components
  ...
  // Memoize context value to prevent re-rendering all consumers when AppProvider parent re-renders
  // or when unrelated local state in AppProvider changes.
  const contextValue = useMemo(() => ({
    ...
    user, loading, logout, cart, addToCart, removeFromCart, updateQuantity, clearCart,
    location, setLocation, favorites, toggleFavorite, products, bundles, sellers, orders,
    addOrder, updateOrderStatus, markOrderCompleted, addresses, addAddress,
    paymentMethods, setDefaultPayment
  ]);
