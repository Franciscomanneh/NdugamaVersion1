...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION: Memoized state-updating functions.
   * Using useCallback ensures these function references remain stable across re-renders,
   * preventing child components that use them from unnecessary re-renders.
   */
  ...
  /**
   * ⚡ BOLT OPTIMIZATION: Memoized Context Value.
   * This ensures that the context object itself only changes when its dependencies change.
   * This prevents ALL consuming components from re-rendering every time any state in
   * AppProvider changes (like an unrelated data fetch or local state update).
   */
