...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION: Memoized context functions
   * Using useCallback with functional state updates to keep dependency arrays stable.
   * This prevents child components from re-rendering unless absolutely necessary.
   */
   ...
   * Prevents global re-render cascades by ensuring the provider's value object
   * only changes when its underlying dependencies change.
   */
  const contextValue = useMemo(() => ({
    ...
    user, loading, logout,
    cart, addToCart, removeFromCart, updateQuantity, clearCart,
    location, favorites, toggleFavorite,
    products, bundles, sellers, orders,
    addOrder, updateOrderStatus, markOrderCompleted,
    addresses, addAddress,
    paymentMethods, setDefaultPayment,
