...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // PERFORMANCE: Memoized action functions to prevent downstream re-renders
  ...
  // PERFORMANCE: Memoized context value to prevent all consumers from re-rendering
  // whenever any single state piece (like current time or irrelevant data) changes.
  const contextValue = useMemo(() => ({
    ...
    clearCart, location, setLocation, favorites, toggleFavorite,
