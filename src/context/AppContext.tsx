...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // PERFORMANCE: Memoize all state-updating functions to prevent unnecessary re-renders in consumer components
  ...
  const handleSetLocation = useCallback((loc: string) => setLocation(loc), []);

  // PERFORMANCE: Memoize the context value to prevent global re-render cascades
  const contextValue = useMemo(() => ({
    ...
    addresses, paymentMethods, logout, addToCart, removeFromCart, updateQuantity,
    clearCart, handleSetLocation, toggleFavorite, addOrder, updateOrderStatus,
    markOrderCompleted, addAddress, setDefaultPayment
  ]);
