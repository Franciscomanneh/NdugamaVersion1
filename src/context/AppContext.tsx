...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt Optimization: Memoized context functions to prevent unnecessary re-renders in consumer components
  ...
  // ⚡ Bolt Optimization: Memoized context value to prevent global re-render cascades
