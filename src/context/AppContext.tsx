...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // BOLT OPTIMIZATION: Memoize context functions to prevent unnecessary re-render cascades
  // throughout the component tree. Functional updates are used to maintain stable references.
  ...
  // BOLT OPTIMIZATION: Memoize the context value object to ensure that consumers only
  // re-render when the actual state they consume has changed.
  const contextValue = useMemo(() => ({
    ...
    user, loading, logout,
    cart, addToCart, removeFromCart, updateQuantity, clearCart,
    location, setLocation, favorites, toggleFavorite,
    products, bundles, sellers, orders,
    addOrder, updateOrderStatus, markOrderCompleted,
    addresses, addAddress,
    paymentMethods, setDefaultPayment
