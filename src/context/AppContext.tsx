...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ⚡ Bolt: Memoize logout to prevent unnecessary re-renders in profile components
  const logout = useCallback(async () => {
    await firebaseService.logoutUser();
  }, []);

  // ⚡ Bolt: Memoize cart operations using functional updates for stable dependency arrays
  ...
  // ⚡ Bolt: Memoize the entire context value to prevent application-wide re-render cascades
  // This ensures that consumers only re-render if the state they depend on actually changes.
