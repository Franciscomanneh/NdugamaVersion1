...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const setLocationCallback = useCallback((loc: string) => setLocation(loc), []);
  ...
  const contextValue = useMemo(() => ({
    ...
    location, setLocationCallback, favorites, toggleFavorite, products, bundles, sellers,
    orders, addOrder, updateOrderStatus, markOrderCompleted, addresses, addAddress,
