...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // PERFORMANCE: Memoized context functions to maintain stable references
  ...
  const wrappedSetLocation = useCallback((loc: string) => setLocation(loc), []);

  // PERFORMANCE: Memoize the context value to prevent unnecessary re-renders of consumers
  const contextValue = useMemo(() => ({
    user, loading, isLoggedIn: !!user, logout,
    cart, addToCart, removeFromCart, updateQuantity, clearCart,
    location, setLocation: wrappedSetLocation,
    ...
    user, loading, logout, cart, addToCart, removeFromCart, updateQuantity,
    clearCart, location, wrappedSetLocation, favorites, toggleFavorite,
    products, bundles, sellers, orders, addOrder, updateOrderStatus,
    markOrderCompleted, addresses, addAddress, paymentMethods, setDefaultPayment
  ]);
