...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateLocation = useCallback((loc: string) => setLocation(loc), []);
  ...
  // PERFORMANCE: Stabilize functions with useCallback
  ...
  // PERFORMANCE: Memoize the Provider value to prevent unnecessary re-renders of consumer components
  const contextValue = useMemo(() => ({
    user, loading, isLoggedIn: !!user, logout,
    cart, addToCart, removeFromCart, updateQuantity, clearCart,
      location, setLocation: updateLocation,
