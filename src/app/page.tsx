...
// Move static constants outside the component to prevent re-allocation on every render
...
export default function HomePage() {
  ...
  // Memoize filtered results to prevent expensive re-calculations on unrelated state changes
  // and pre-lowercase searchQuery to avoid redundant operations in loops.
  const query = searchQuery.toLowerCase();

  const filteredBundles = useMemo(() =>
    bundles.filter(b => b.bundleName.toLowerCase().includes(query)),
    [bundles, query]
  );
