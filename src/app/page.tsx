...
// ⚡ Bolt: Lifting static data outside component prevents re-allocation on every render
...
export default function HomePage() {
  ...
  // ⚡ Bolt: Memoizing filtered lists to prevent expensive re-calculation on every render
  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <section className="px-6">
        ...
        >
          {/* ⚡ Bolt: Using Next.js Image with priority for LCP optimization */}
          <Image
