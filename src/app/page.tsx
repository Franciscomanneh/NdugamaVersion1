...
// Performance: Hoist static arrays outside the component to prevent re-allocation on every render.
...
export default function HomePage() {
  ...
  // Performance: Memoize filtered bundles to avoid redundant filtering on every render.
  const filteredBundles = useMemo(() =>
    bundles.filter(b =>
      b.bundleName.toLowerCase().includes(searchQuery.toLowerCase())
    ), [bundles, searchQuery]);

  // Performance: Memoize filtered products to avoid redundant filtering on every render.
  ...
  // Performance: Memoize featured sellers to avoid redundant filtering on every render.
