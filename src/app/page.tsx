...
// BOLT OPTIMIZATION: Moved static arrays outside the component to prevent unnecessary re-allocations on every render.
...
export default function HomePage() {
  ...
  // BOLT OPTIMIZATION: Memoized filtered bundles and products to avoid redundant filtering on every render.
  // This improves performance when searching or when unrelated state (like donation modal) changes.
