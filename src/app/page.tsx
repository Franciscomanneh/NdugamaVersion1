...
export default function HomePage() {
  ...
  // Memoize filtered bundles to avoid recalculation on unrelated state changes (like donation modal)
  ...
  // Memoize featured sellers to avoid filtering/slicing on every render
