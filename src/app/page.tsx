...
export default function HomePage() {
  ...
  // Performance Optimization: Memoize filtered bundles to avoid recalculation on every render
  ...
  // Performance Optimization: Memoize filtered products to avoid recalculation on every render
  ...
  // Performance Optimization: Memoize featured gardeners to avoid recalculation on every render
  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <section className="px-6">
        ...
        >
          {/* Performance Optimization: Use Next.js Image component for automatic optimization and LCP improvement */}
          <Image
