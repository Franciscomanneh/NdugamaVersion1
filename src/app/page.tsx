...
export default function HomePage() {
  ...
  // Performance: Memoize filtered bundles to avoid recalculation on every re-render
  ...
  // Performance: Memoize filtered products to avoid recalculation on every re-render
  ...
  // Performance: Memoize featured gardeners to avoid recalculation
