...
// PERFORMANCE: Move static arrays outside component to avoid recreation on every render
...
export default function HomePage() {
  ...
  // PERFORMANCE: Memoize filtering results to avoid redundant calculations on every render
