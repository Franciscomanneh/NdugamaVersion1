...
// ⚡ Bolt Optimization: Hoist static constants to prevent recreation on every render
...
export default function HomePage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered lists to avoid redundant computations during state updates (e.g. search)
