...
// Static data moved outside component to prevent redundant allocations on every render
...
export default function HomePage() {
  ...
  // Memoizing filtered results to prevent expensive re-filtering on every render
  // unless the source data (bundles, products) or search query actually changes.
