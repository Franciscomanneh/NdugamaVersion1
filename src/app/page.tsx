...
// PERFORMANCE: Define static data outside of the component to prevent re-creation on every render
...
export default function HomePage() {
  ...
  // PERFORMANCE: Memoize filtered results to avoid recalculation on unrelated state changes (e.g. donation modal toggle)
