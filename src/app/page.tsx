...
/**
 * ⚡ Bolt Optimization: Hoisting static constants outside the component
 * to prevent redundant object/array creation on every render.
 */
...
export default function HomePage() {
  ...
  /**
   * ⚡ Bolt Optimization: Memoizing filtered results to prevent expensive
   * re-filtering on every re-render (e.g., when cart or favorites change).
   */
  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <section className="px-6">
        ...
        >
          {/**
           * ⚡ Bolt Optimization: Using Next.js Image component with priority
           * for the Hero image to improve LCP (Largest Contentful Paint).
           */}
          <Image
